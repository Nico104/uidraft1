...
class SubModUpdateAbout extends StatefulWidget {
  const SubModUpdateAbout({Key? key}) : super(key: key);

  @override
  _SubModUpdateAboutState createState() => _SubModUpdateAboutState();
}

class _SubModUpdateAboutState extends State<SubModUpdateAbout> {
  int _showActivity = 0;
