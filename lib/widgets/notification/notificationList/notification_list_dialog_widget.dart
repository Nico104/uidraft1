        ...
        child: AnimatedContainer(
          ...
          child: AnimatedOpacity(
            ...
            child: ScrollConfiguration(
              ...
              child: FutureBuilder(
                  future: fetchUserNotifications(connection.returnConnection()),
                                ...
                                return InkWell(
                                    ...
                                    child: snapshot.data!.elementAt(index)['title'] !=
                                        ...
                                        ? NotificationItem(
                                            ...
                                            //         ['userProfile']
                                            // ['profilePicturePath'],
                                            assignedDate: snapshot.data!.elementAt(
                                                index)['assignedDate'])
                                        : MessageItem(
                                            username: snapshot.data!.elementAt(
                                                index)['formUsername'],
                                            notificationText: snapshot.data!
                                                .elementAt(
                                                    index)['notificationText'],
                                            picturePath: snapshot.data!
                                                ...
                                                ['userProfile']['profilePicturePath'],
                                            assignedDate: snapshot.data!.elementAt(index)['assignedDate']));
                              },
                            ),
                          );
                        }
